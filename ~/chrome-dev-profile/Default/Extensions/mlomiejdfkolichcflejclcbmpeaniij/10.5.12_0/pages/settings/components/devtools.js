...
import Config, { ACTION_DISABLE_AUTOCONSENT, ACTION_DISABLE_ANTITRACKING_MODIFICATION, ACTION_PAUSE_ASSISTANT, FLAG_PAUSE_ASSISTANT, FLAG_FIREFOX_CONTENT_SCRIPT_SCRIPTLETS, FLAG_CHROMIUM_INJECT_COSMETICS_ON_RESPONSE_STARTED, FLAG_EXTENDED_SELECTORS, FLAG_DYNAMIC_DNR_FIXES } from '../../../store/config.js';
...
const __vite_glob_0_2 = {
  ...
  render: ({ visible, counter, options, config, resources }) => html`
    ...
    ([name, d]) => html`<ui-text color="secondary">
                          ${name} (${d.actions.join(", ")})
                        </ui-text>`
  ) || "none"}
                </div>
...
export { asyncAction, __vite_glob_0_2 as default };

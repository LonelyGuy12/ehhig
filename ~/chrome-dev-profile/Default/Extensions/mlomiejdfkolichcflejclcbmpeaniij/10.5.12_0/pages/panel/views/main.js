...
import __vite_glob_0_17 from './menu.js';
import __vite_glob_0_21 from './tracker-details.js';
import __vite_glob_0_18 from './protection-status.js';
import __vite_glob_0_20 from './report-form.js';
import __vite_glob_0_19 from './report-confirm.js';
import __vite_glob_0_22 from './whotracksme.js';
        ...
        html`
          <ui-header>
            ...
            html`
              <ui-action slot="actions">
                <a href="${router.url(__vite_glob_0_17)}" data-qa="button:menu">
          ...
          html`
            <panel-actions hostname="${stats.displayHostname}">
              ...
              <panel-actions-button>
                <a href="${router.url(__vite_glob_0_20)}">
                ...
                >
                  <ui-tooltip position="bottom" slot="actions">
                    ...
                    <ui-action-button layout="size:4.5">
                      <a href="${router.url(__vite_glob_0_22)}">
